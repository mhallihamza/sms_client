  ...
  return (
    <div className="flex min-h-screen gap-3 px-3">
      ...
      <div className="bg-[#f6f8f8] overflow-auto font-medium h-full text-sm border-gray-200 border rounded-lg">
       ...
       <ul>
        <li className="bg-[#fbece6] flex items-center gap-4 py-2 pl-6 border-r-2 border-[#ff5b1a]">
          <TbLayoutDashboardFilled  className="h-5 w-5"/>
          <span>Dashboard</span>
        </li>
        <li>
         <Link to="/calender" className="flex items-center gap-3 py-2 pl-5">
          <img className="h-7 w-7" src="/images/calendar.svg"></img>
          <span>Calender</span>
         </Link>
        </li>
        <li>
         <Link to="/appointments" className="flex items-center gap-3 py-2 pl-5">
          <img className="h-7 w-7" src="/images/appointment.svg"></img>
          <span>Appointments</span>
         </Link>
        </li>
        <li>
         <Link to="/payments" className="flex items-center gap-4 py-2 pl-6">
          <BiSolidDollarCircle className="h-5 w-5"/>
          <span>Payments</span>
         </Link>
        </li>
        <li>
         <Link to="/customers" className="flex items-center gap-4 py-2 pl-6">
          <FaUserGroup className="h-5 w-5"/>
          <span>Customers</span>
         </Link>
        </li>
        <li>
        <Link to="/services" className="flex items-center gap-3 py-2 pl-6">
          <MdMiscellaneousServices className="h-6 w-6"/>
          <span>Services</span>
        </Link>
        </li>
        <li>
        <Link to="/treatments" className="flex items-center gap-3 py-2 pl-7">
      ...
      <div className="flex flex-col w-[85%]">
        ...
        <div className="flex flex-1 gap-3 pb-3">
          <div className="bg-[#f6f8f8] px-4 py-4 w-[75%] rounded-lg font-medium border-gray-200 border">
            <Outlet />
          </div>
          <div className="bg-red-400 w-[25%] rounded-lg"></div>
        </div>
      </div>
    </div>
  )
