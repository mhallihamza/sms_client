      ...
      <div className="h-screen sticky z-20 top-0 inset-x-0 w-[15%] py-3">
        <div className="bg-[#fbfcfc] overflow-auto font-medium h-full text-sm border-gray-200 border rounded-lg">
          ...
          <ul>
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "bg-[#fbece6] flex items-center gap-4 py-2 pl-6 hover:bg-orange-500 border-r-2 border-orange-500"
                    : "flex items-center hover:bg-orange-500 gap-4 py-2 pl-6"
                }
              >
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "bg-[#fbece6] hover:bg-orange-500 flex items-center gap-3 py-2 pl-5 border-r-2 border-orange-500"
                    : "flex items-center hover:bg-orange-500 gap-3 py-2 pl-5"
                }
              >
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "bg-[#fbece6] flex items-center hover:bg-orange-500 gap-3 py-2 pl-5 border-r-2 border-orange-500"
                    : "flex items-center hover:bg-orange-500 gap-3 py-2 pl-5"
                }
              >
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "bg-[#fbece6] flex items-center hover:bg-orange-500 gap-4 py-2 pl-6 border-r-2 border-orange-500"
                    : "flex items-center hover:bg-orange-500 gap-4 py-2 pl-6"
                }
              >
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "bg-[#fbece6] flex items-center gap-3 hover:bg-orange-500 py-2 pl-6 border-r-2 orange-500"
                    : "flex items-center hover:bg-orange-500 gap-3 py-2 pl-6"
                }
              >
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "bg-[#fbece6] flex items-center gap-4 hover:bg-orange-500 py-2 pl-6 border-r-2 border-orange-500"
                    : "flex items-center hover:bg-orange-500 gap-4 py-2 pl-6"
                }
              >
            ...
            <li>
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? "bg-[#fbece6] flex items-center gap-4 hover:bg-orange-500 py-2 pl-7 border-r-2 border-orange-500"
                    : "flex items-center hover:bg-orange-500 gap-4 py-2 pl-7"
                }
              >
            ...
            <li>
              <button
                className="flex items-center gap-4 hover:bg-orange-500 w-full py-2 pl-[25px]"
          ...
          <div className="flex flex-col gap-3 mt-32 mb-4 text-white mx-5">
            ...
            <button className="bg-neutral-900 rounded py-2">
              Add Hairstylist
            </button>
          </div>
        </div>
        ...
        <div className="flex bg-white z-10 sticky pb-5 pt-3 top-0 inset-x-0 font-medium text-sm justify-between">
          <div className="flex gap-4">
            ...
            <div className="flex gap-2">
              ...
              <div className="bg-[#f6f8f8] border-gray-200 border flex items-center rounded px-4">
                Today
              </div>
              <button className="bg-[#f6f8f8] border-gray-200 border rounded px-2">
                <IoIosArrowForward />
