  ...
  return (
    <div>
        <div className="flex justify-between">
            <h1 className="font-poppins font-semibold text-lg">Overview</h1>
            <button className="flex items-center gap-1 text-xs text-gray-600 font-poppins">
                <p>This month</p>
                <IoIosArrowDown />
            </button>
        </div>
        <div className="grid font-poppins grid-cols-4 gap-3">
            <div className="w-full bg-gradient-to-l from-orange-600 to-orange-500 rounded-xl text-white p-4">
                ...
                <p className="text-lg font-semibold">980</p>
            ...
            <div className="w-full bg-gradient-to-l from-[#06BF9D] to-[#74ddc3]  rounded-xl text-white p-4">
                ...
                <p className="text-lg font-semibold">1205</p>
            ...
            <svg className="h-5 w-5 text-[#fad951]"
    fill="currentColor" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
